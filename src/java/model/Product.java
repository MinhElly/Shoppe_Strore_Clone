...
public class Product {
    ...
    public Product(int productID, String productName, String image, double price, int quantity, int soldQuantity, String describe, String categoryID, Date importDate, Date usingDate, int status) {
